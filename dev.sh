...
# Guard against version conflicts between this app and the pinned hop-core release. hop-core
# owns the versions of its own dependencies; this warns loudly if an app pin ever violates a
# hop-core range.
